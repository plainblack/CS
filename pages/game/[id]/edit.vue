<template>
    ...
    <FieldsetNav v-if="game.props">
        <FieldsetItem name="Properties">
                    ...
                    <div class="mb-4">
                        <FormInput name="name" type="text" v-model="game.props.name" required label="Name" @change="game.update()" />
                    </div>
                    <div class="mb-4">
                        <FormInput name="notes" type="text" v-model="game.props.notes"  label="Notes" @change="game.update()" />
                    </div>
                    <div class="mb-4">
                        <FormInput name="userId" type="text" v-model="game.props.userId" required label="User Id" @change="game.update()" />
                    </div>
                    <div class="mb-4">
                        <FormSelect name="archived" :options="game.options.archived" v-model="game.props.archived" label="Archived" @change="game.update()" />
                    </div>
                    <div class="mb-4">
                        <FormInput name="collection" type="text" v-model="game.props.collection" required label="Collection" @change="game.update()" />
                    </div>
        </FieldsetItem>
        ...
        <FieldsetItem name="Actions">
            ...
            <Button @click="game.delete()" severity="danger" class="mr-2 mb-2" title="Delete" alt="Delete Game"><i class="pi pi-trash mr-1"></i> Delete</Button>
        </FieldsetItem>
