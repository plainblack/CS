<template>
    <ul
        ...
        <li class="mt-1">
            ...
            <NuxtLink :to="`/game`" class="no-underline mr-2 mb-2">
                <Button severity="primary" title="Back to Games" alt="Back"><i class="pi pi-arrow-left mr-1"></i> Back
                    to
                    Games</Button>
            </NuxtLink>
        </li>
...
const navigation = [
    ...
    { name: 'API Keys', href: '/user/settings/apikeys', icon: 'pi pi-unlock' },
    { name: 'Admin', href: '/user/admin', icon: 'pi pi-users' },
]
</script>